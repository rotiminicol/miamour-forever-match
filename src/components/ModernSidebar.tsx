...
const ModernSidebar = () => {
  ...
  const sidebarVariants = {
    expanded: { width: isMobile ? '80vw' : '260px' },
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={`fixed md:sticky top-0 left-0 h-screen bg-white/95 border-r border-gray-100/50 z-30 overflow-hidden custom-scrollbar shadow-lg backdrop-blur-sm max-w-[400px] ${
        ...
        <div className="flex flex-col h-full">
          ...
          <AnimatePresence>
            {isMobile && isExpanded && (
              <motion.button
                onClick={() => setIsExpanded(false)}
                className="absolute top-4 right-3 p-1.5 rounded-full hover:bg-gray-100/50 transition-all text-gray-500 hover:text-gray-700"
