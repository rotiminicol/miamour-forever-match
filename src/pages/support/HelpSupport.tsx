  ...
  const faqItems = [
    {
      ...
      answer: "Our matching system uses a sophisticated algorithm that considers your preferences, interests, values, and personality traits to find compatible matches. The more information you provide in your profile and preferences, the better matches we can suggest for you."
    },
    {
      question: "Can I change my subscription plan?",
      answer: "Yes, you can change your subscription plan at any time. Go to 'Subscriptions' in your account settings to view available options. When upgrading, you'll immediately gain access to new features. When downgrading, changes will take effect at the end of your current billing period."
    },
    {
      question: "How can I schedule a therapy session?",
      answer: "To schedule a therapy session, navigate to the 'Appointments' section from your dashboard. Select 'Therapy Sessions' from the services menu, choose a therapist, and pick an available time slot that works for you. You'll receive a confirmation email with session details."
    },
    {
      question: "What is the cancellation policy for appointments?",
      answer: "Appointments can be cancelled or rescheduled up to 24 hours before the scheduled time without any penalty. For cancellations made with less than 24 hours notice, a cancellation fee equal to 50% of the session cost may apply."
    },
    {
      question: "How do I update my preferences?",
      answer: "To update your match preferences, go to the 'Preferences' section in your account settings. There, you can modify attributes like age range, location preferences, and important values or interests you're looking for in a potential match."
    }
  ];
